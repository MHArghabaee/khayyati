...
#
# def create_zip_from_files(zip_name, file_paths):
#     try:
...
#
#     body = 'Please find the requested files attached as a zip archive.'
#     msg.attach(MIMEText(body, 'plain'))
#
#     # افزودن فایل زیپ به ایمیل
...
#         zip_name = 'latest_files.zip'
#         zip_path = create_zip_from_files(zip_name, all_latest_files)
#         if zip_path:
...
#         zip_name = 'specific_files.zip'
#         zip_path = create_zip_from_files(zip_name, specific_files)
#         if zip_path:
#             send_email_with_attachment(zip_path)
